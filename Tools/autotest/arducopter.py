...
#        self.wait_generator_speed_and_state(3000, 30000, mavutil.mavlink.MAV_GENERATOR_STATUS_FLAG_WARMING_UP)
    ...
    def Loweheiser(self):
        ...
        self.set_parameters({
            ...
            "RC%u_OPTION" % loweheiser_man_throt_ch: 212,  # loweheiser manual throttle control
            ...
            "RC%u_OPTION" % loweheiser_man_start_ch: 109, # loweheiser starter channel
        })
